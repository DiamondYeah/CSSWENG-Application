...
router.get("/linkedin/connect-link", findAccountAuth, (req: AuthUserRequest, res: Response) => {
...
router.get("/linkedinlogin", (req: Request, res: Response) => {
    ...
    console.log("CSRF cookie created:", csrfState);

    res.redirect(createLinkedInAuth(combinedState));

});

router.get("/linkedin/oauth2/callback", async (req: AuthUserRequest, res: Response) => {
    ...
    console.log("Received state:", csrfState);
    console.log("Saved cookie:", savedState);
