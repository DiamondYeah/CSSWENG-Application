...
- Added LinkedIn Post Route for handling all LinkedIn posting requests.
...
- Accounts page now supports both TikTok and LinkedIn accounts.
...
- Calendar Scheduling with LinkedIn support.
...
ACCOUNTS_REIDRECT_URL=http://localhost:5173/accounts
...
In the LinkedIn Developer Portal, add the following Authorized Redirect URL:
...
Navigate to the **Accounts** page and click **Connect LinkedIn** to begin the OAuth authentication flow.